        ...
        try {
            ...
            if ($this->data instanceof Episode) {
                $client->post(self::FIREBASE_URL, [
                    'json' => [
                        'to' => self::NOTIFS,
                        'data' => ['instanceof' => 'episode', 'tmdb' => $this->data->id,'type' => "episode",'title' => $this->data->name
                        ,'message' => $this->data->overview,'image' => $this->data->still_path]
                    ]
                ]);
            }
            ...
            if ($this->data instanceof Movie) {
                $client->post(self::FIREBASE_URL, [
                    'json' => [
                        'to' => self::NOTIFS,
                        'data' => ['instanceof' => 'movie', 'tmdb' => $this->data->tmdb_id,'type' => "0",'title' => $this->data->title
            ...
            if ($this->data instanceof Serie) {
                $client->post(self::FIREBASE_URL, [
                    'json' => [
                        'to' => self::NOTIFS,
                        'data' => ['instanceof' => 'serie', 'tmdb' => $this->data->tmdb_id,'type' => "1",'title' => $this->data->name
                        ,'message' => $this->data->overview,'image' => $this->data->backdrop_path]
                    ]
                ]);
            }
            ...
            if ($this->data instanceof Anime) {
                $client->post(self::FIREBASE_URL, [
                    'json' => [
                        'to' => self::NOTIFS,
                        'data' => ['instanceof' => 'anime', 'tmdb' => $this->data->tmdb_id,'type' => "2",'title' => $this->data->name
                        ,'message' => $this->data->overview,'image' => $this->data->backdrop_path]
                    ]
                ]);
            }
